...
FUN-INVALID-NAME - If provided name is longer than 10 characters, the system shall print "Your cat's name is too long. Rename your cat and try again." and shut down.

FUN-NON-INTEGER-WEIGHT - If provided weight is not an integer, the system shall terminate and display a Java InputMismatchException stack trace.
